...
struct BerlinClockEngineTests {
    ...
    @Test("five minutes lamp test when minutes = 5")
    func fiveMinutesLamp_whenMinutes_IsEqual_5() {
        let minutes: UInt = 5
    ...
    @Test("five minutes lamp test when minutes = 10")
    func fiveMinutesLamp_whenMinutes_IsEqual_10() {
        let minutes: UInt = 10
        let original = engine.fiveMinutesToLamp(minutes: minutes)
    ...
    @Test("five minutes lamp test when minutes = 20")
    func fiveMinutesLamp_whenMinutes_IsEqual_20() {
        let minutes: UInt = 20
        let original = engine.fiveMinutesToLamp(minutes: minutes)
    ...
    @Test("five minutes lamp test when minutes = 25")
    func fiveMinutesLamp_whenMinutes_IsEqual_25() {
        let minutes: UInt = 25
        let original = engine.fiveMinutesToLamp(minutes: minutes)
