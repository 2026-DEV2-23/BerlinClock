...
struct BerlinClockEngineTests {
    ...
    @Test("one hour lamp test when hour = 1, 6", arguments: [1, 6])
    func oneHourLamp_whenHours_IsEqual_1(hours: UInt) {
    ...
    @Test("one hour lamp test when hour = 2")
    func oneHourLamp_whenHours_IsEqual_2() {
        let hours: UInt = 2
        let original = engine.oneHourToLamp(hours: hours)
    ...
    @Test("one hour lamp test when hour = 3")
    func oneHourLamp_whenHours_IsEqual_3() {
        let hours: UInt = 3
        let original = engine.oneHourToLamp(hours: hours)
    ...
    @Test("one hour lamp test when hour = 4")
    func oneHourLamp_whenHours_IsEqual_4() {
        let hours: UInt = 4
        let original = engine.oneHourToLamp(hours: hours)
    ...
    @Test("one hour lamp test when hour = 0")
    func oneHourLamp_whenHours_IsEqual_0() {
        let hours: UInt = 0
        let original = engine.oneHourToLamp(hours: hours)
